...
public class MediaController extends FrameLayout {
  ...
  public boolean mFromXml = false;
  private ImageButton mPauseButton;
  private AudioManager mAM;
  private OnShownListener mShownListener;
  private OnHiddenListener mHiddenListener;
  private ImageView mMediacontrollerFullscreen;
...
//TODO 设置屏幕
    mMediacontrollerFullscreen = (ImageView) v.findViewById(R.id.ib_full_small);
    mMediacontrollerFullscreen.setOnClickListener(new OnClickListener() {
      @Override
        public void onClick(View view) {
          if(mActivity.getRequestedOrientation()== ActivityInfo.SCREEN_ORIENTATION_PORTRAIT){
            mMediacontrollerFullscreen.setSelected(true);
            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            }else{
            mMediacontrollerFullscreen.setSelected(false);
  ...
  public void setFullScreenIconState(Boolean isSelected){
      mMediacontrollerFullscreen.setSelected(isSelected);
  }
